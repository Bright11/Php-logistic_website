...
if (empty($adminemail)) {
 $error='<div class="error" style="background-color:red;">Please make sure you firlds the empty forms!</div>';
  ...
  $sql ="SELECT * FROM employees WHERE adminemail=?;";
...
<div class="col-md-6">
  <h1>adminemail Information</h1>
<form action="" method="post">
  <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">adminemail</label>
  <input type="text" class="form-control"name="adminemail" id="adminemail" placeholder="adminemail">
</div>
<div class="mb-3">
