...
$sql ="select * from shippinginfo inner join senderinfo on shippinginfo.b_id=senderinfo.b_id inner join branches on shippinginfo.b_id=branches.b_id inner join employees on branches.b_id=employees.b_id where status='Canciled' and em_email='$b_id'";
