  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="senderinfo.php">Sender Registration</a>
        </li>
        ...
        <?php
          ...
          ?>
          <li class="nav-item">
          <a class="nav-link" href="signin.php">Employee Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="adminlogin.php">Admin Login</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="employees.php">Register</a>
        </li>
          <?php
         }
         ?>
