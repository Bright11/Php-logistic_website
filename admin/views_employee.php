...
<div class="table-responsive">
   <h4 class="txt-center">Employee Details</h4>
...
//$sql ="select * from employees where em_email='$b_id'";
$sql ="SELECT * FROM employees INNER JOIN branches ON employees.b_id=branches.b_id WHERE em_email='$b_id' ";
//$show = mysqli_query($mysqli,"SELECT * FROM `Table Name` WHERE `id`='".$_SESSION['user_id'];."'"); 
